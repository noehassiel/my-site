            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-4 d-flex flex-column ">
                    <div class="card card-plain">
                        ...
                        <div class="card-body">
                            <div class="cartoon-container d-flex justify-content-center">
                                <svg class="mySVG" height="250px" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div>
                                <form method="POST" action="{{ route('login.quote') }}">
                                    @csrf
                                    <div style="opacity: 0">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-dark w-100 mt-4 mb-3">Ver
                                            Cotización</button>
                                    </div>
                                </form>
                            </div>
